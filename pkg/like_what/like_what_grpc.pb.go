...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// ManufactureService manages producers of tobacco products.
type ManufactureServiceClient interface {
	...
	ListManufactures(ctx context.Context, in *ListManufacturesRequest, opts ...grpc.CallOption) (*ListManufacturesResponse, error)
...
func (c *manufactureServiceClient) ListManufactures(ctx context.Context, in *ListManufacturesRequest, opts ...grpc.CallOption) (*ListManufacturesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListManufacturesResponse)
...
type ManufactureServiceServer interface {
	...
	ListManufactures(context.Context, *ListManufacturesRequest) (*ListManufacturesResponse, error)
...
func (UnimplementedManufactureServiceServer) ListManufactures(context.Context, *ListManufacturesRequest) (*ListManufacturesResponse, error) {
...
func _ManufactureService_ListManufactures_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListManufacturesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManufactureServiceServer).ListManufactures(ctx, req.(*ListManufacturesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
